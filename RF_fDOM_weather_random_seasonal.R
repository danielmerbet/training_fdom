...
write.csv(save_rsq, file=paste0(dir, "output/rsq_movingtest_seasonal.csv"), quote = F, row.names = F)
write.csv(save_rmse, file=paste0(dir, "output/rmse_movingtest_seasonal.csv"), quote = F, row.names = F)
write.csv(save_nse, file=paste0(dir, "output/nse_movingtest_seasonal.csv"), quote = F, row.names = F)
write.csv(save_importance, file=paste0(dir, "output/save_importance_seasonal.csv"), quote = F)
write.csv(save_perc, file=paste0(dir, "output/save_perc_seasonal.csv"), quote = F)
